...
import net.feuapp.daihuudsf.customadapters.CustomAdapterChuyenBien;
...
public class ChuyenBienActivity extends AppCompatActivity {
    ...
    private void initialization(){
        ...
        if (!userName.substring(0,5).equals("admin")){
            ...
            //pull from server ******************************************************
            final String BASE_URL= MY_SERVER + "/daihuudsf/user";
    ...
    private void addEvents() {
        ...
        spnChuyenBien.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent,View view, int position, long id) {
                ...
                tvChuyenBienDSTV.setText(SoTV+ " Thuyền viên");
...
//        }
        ...
        if (edit_mode=="NEW" && tvRkey.getText().equals("")) {
            ...
            if (edit_mode=="EDIT"){
                ...
                chuyenbien.setServerkey(Integer.valueOf(String.valueOf(tvServerkey.getText())));
