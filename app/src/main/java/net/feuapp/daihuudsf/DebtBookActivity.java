...
import net.feuapp.daihuudsf.customadapters.CustomAdapterDebtBook;
...
public class DebtBookActivity extends AppCompatActivity {
    ...
    private void gotoDebtBookDetail(int position){
        ...
        if (chiTietNoThuyenVien.size()>0) {
            ...
            Toast.makeText(DebtBookActivity.this, "Thuyền viên này vẫn chưa ứng tiền", Toast.LENGTH_SHORT).show();
        }
    }
        ...
        edtSotien.setOnFocusChangeListener(new View.OnFocusChangeListener() {
            ...
            public void onFocusChange(View v, boolean hasFocus) {
                if (!hasFocus){
                    ...
                    if (longGet(edtSotien.getText()+"")==0){
                        edtSotien.setSelectAllOnFocus(true);
                    }
                }
            }
        });
