...
public class updateSoftwareService extends Service {
    ...
    private void checkNewUpdate() throws ExecutionException, InterruptedException {
        ...
        if (!version.equals("")){
            //ArrayList<?> res =new restfullAPI.checkUpdate().execute(MY_SERVER + "/daihuudsf/checkupdate/").get();
                ...
                public void onUpdate(ArrayList<?> res) {
                    ...
                    for (int i=0;i<res.size();i++){
                        ...
                        if (fileExt.equals("apk")){
                            try{
                                String StrNewVer=fileName.replaceAll("daihuudsf_","");
                                ...
                                if (newVer>oldVer){
                                    ...
                                    dialogBuilder.setMessage("- Phiên bản đang dùng: "+ newVersion + "\n" +
                                                    "- Phiên bản vá lổi mới: " + fileName.replaceAll("daihuudsf_","")
                                                    + "\n" + "\n"+ "Chọn Yes để tải về.");
                                    ...
                                    dialogBuilder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                                               public void onClick(DialogInterface dialog, int id) {
                                                   ...
                                                   request.setTitle("Dai Huu DSF - software update");
                                                    //set destination
                                    ...
                                    // Set fixed width (300dp) and WRAP_CONTENT height
            ...
            updatetask.execute(new String[]{MY_SERVER + "/daihuudsf/checkupdate/"});
        }
    }
