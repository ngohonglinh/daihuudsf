...
import net.feuapp.daihuudsf.NavDrawerActivity;
...
//****************************CHUYENBIEN*************************************
    ...
    public static class getTVCanCa extends AsyncTask<String, String, ArrayList<TVCanCa>> {

        public interface OnUpdateListener {
            void onUpdate(ArrayList<TVCanCa> obj) throws ExecutionException, InterruptedException;
        }
        public getTVCanCa() {
        }
        OnUpdateListener listener;
        ...
        @Override
        protected ArrayList<TVCanCa> doInBackground(String... strings) {
            Request.Builder builder = new Request.Builder();
            builder.url(strings[0]);

            Request request = builder.build();
            Gson gson = new Gson();
            Type type = new TypeToken<ArrayList<TVCanCa>>() {}.getType();
            ArrayList<TVCanCa>arrTVCanCa;

            try {
                Response response = okHttpClient.newCall(request).execute();
                arrTVCanCa=gson.fromJson(response.body().charStream(),type);
                return arrTVCanCa;
            } catch (IOException e) {
                e.printStackTrace();
            }
        ...
        @Override
        protected void onPostExecute(ArrayList<TVCanCa> arrTVCanCa) {
            super.onPostExecute(arrTVCanCa);
            if (listener != null) {
                try {
                    listener.onUpdate(arrTVCanCa);
                } catch (ExecutionException e) {
                    e.printStackTrace();
                } catch (InterruptedException e) {
                    e.printStackTrace();
    ...
    public  static class postTVCanCa extends AsyncTask<String, Void, ResponseFromServer> {
        public interface OnUpdateListener {
            void onUpdate(ResponseFromServer obj);
        }
        OnUpdateListener listener;
        ...
        public postTVCanCa(TVCanCa tvcanca2) {
            tvcanca.setServerkey(tvcanca2.getServerkey());
            tvcanca.setRkey(tvcanca2.getRkey());
            tvcanca.setRkeythuyenvien(tvcanca2.getRkeythuyenvien());
            tvcanca.setNgayps(tvcanca2.getNgayps());
            tvcanca.setNotes(tvcanca2.getNotes());
            tvcanca.setTenhs(tvcanca2.getTenhs());
            tvcanca.setSoluong(tvcanca2.getSoluong());
            tvcanca.setDongia(tvcanca2.getDongia());
            tvcanca.setGiamgia(tvcanca2.getGiamgia());
            tvcanca.setThanhtien(tvcanca2.getThanhtien());
            tvcanca.setUpdatetime(tvcanca2.getUpdatetime());
            tvcanca.setUsername(tvcanca2.getUsername());
        }
        @Override
        protected void onPreExecute() {
            super.onPreExecute();
        ...
        protected ResponseFromServer doInBackground(String... strings) {
            ...
            Gson gson = new Gson();
            Type type = new TypeToken<TVCanCa>() {}.getType();
            String json = gson.toJson(tvcanca, type);
            RequestBody body = RequestBody.create(JSON, json);
            Request request =new Request.Builder()
                    .url(strings[0])
                    .post(body)
    ...
    public  static class putTVCanCa extends AsyncTask<String, Void, ResponseFromServer> {
        public interface OnUpdateListener {
            void onUpdate(ResponseFromServer obj);
        }
        OnUpdateListener listener;
        ...
        public putTVCanCa(TVCanCa tvcanca2) {
            tvcanca=tvcanca2;
        }
        @Override
        protected void onPreExecute() {
        ...
        protected ResponseFromServer doInBackground(String... strings) {
            ...
            Gson gson = new Gson();
            Type type = new TypeToken<TVCanCa>() {}.getType();
            String json = gson.toJson(this.tvcanca, type);
            RequestBody body = RequestBody.create(JSON, json);
            Request request =new Request.Builder()
                    .url(strings[0])
                    .put(body)
    ...
    public  static class deleteTVCanCa extends AsyncTask<String, Void, ResponseFromServer> {
        public interface OnUpdateListener {
            void onUpdate(ResponseFromServer obj);
        }
        OnUpdateListener listener;
        public deleteTVCanCa() {
        }
        public void setUpdateListener(OnUpdateListener listener) {
            this.listener = listener;
        }
