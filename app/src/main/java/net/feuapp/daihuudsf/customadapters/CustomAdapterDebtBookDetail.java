...
/**
 * Created by linh3 on 30/12/2017.
 */

public class CustomAdapterDebtBookDetail extends BaseAdapter {
    ...
    public CustomAdapterDebtBookDetail(Context context, int myLayout, ArrayList<DebtBook> mylist) {
