...
public class CustomAdapterUser extends BaseAdapter {
    ...
    public CustomAdapterUser(Context context, int myLayout, ArrayList<Users> mylist) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final TextView tv1 = convertView.findViewById(R.id.customlist_user_tv1);
        final TextView tv2 = convertView.findViewById(R.id.customlist_user_tv2);
        final TextView tv3 = convertView.findViewById(R.id.customlist_user_tv3);
        final LinearLayout ly=convertView.findViewById(R.id.customlist_user_ly);

        Users user=arrList.get(position);
        tv1.setText(String.valueOf(position + 1));
        tv2.setText(user.getEmail());
        tv3.setText(user.getFullname());
