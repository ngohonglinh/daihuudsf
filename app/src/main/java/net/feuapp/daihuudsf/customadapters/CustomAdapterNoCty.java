...
public class CustomAdapterNoCty extends BaseAdapter {

    Context context;
    int myLayout;
    ArrayList<Thu> arrayList;


    public CustomAdapterNoCty(Context context, int myLayout, ArrayList<Thu> arrayList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final LinearLayout ly=convertView.findViewById(R.id.customlist_ctyno_ly);
