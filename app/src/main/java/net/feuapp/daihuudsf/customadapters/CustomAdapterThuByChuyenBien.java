...
import net.feuapp.daihuudsf.models.ThuByChuyenBien;
...
public class CustomAdapterThuByChuyenBien extends BaseAdapter{
    final private String TAG = getClass().getSimpleName();

    Context context;
    int myLayout;
    ArrayList<ThuByChuyenBien> arrayList;


    public CustomAdapterThuByChuyenBien(Context context, int myLayout, ArrayList<ThuByChuyenBien> arrayList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        tv2.setText(arrayList.get(position).getmKhachHang());
