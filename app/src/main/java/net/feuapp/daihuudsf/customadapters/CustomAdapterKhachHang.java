...
public class CustomAdapterKhachHang extends BaseAdapter {

    Context context;
    int myLayout;
    ArrayList<KhachHang> arrayList;
    final private String TAG = getClass().getSimpleName();
    public CustomAdapterKhachHang(Context context, int myLayout, ArrayList<KhachHang> arrayList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        tv2.setText(arrayList.get(position).getTenkhach());
