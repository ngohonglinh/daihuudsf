package net.feuapp.daihuudsf.syncAdapter;
...
import net.feuapp.daihuudsf.crudmanager.restfullAPI;
import net.feuapp.daihuudsf.models.BanHSDetail;
import net.feuapp.daihuudsf.models.Chi;
import net.feuapp.daihuudsf.models.ChiDetail;
import net.feuapp.daihuudsf.models.ChuyenBien;
import net.feuapp.daihuudsf.models.DMHaiSan;
import net.feuapp.daihuudsf.models.DSTV;
import net.feuapp.daihuudsf.models.DebtBook;
import net.feuapp.daihuudsf.models.DiemDD;
import net.feuapp.daihuudsf.models.DoiTac;
import net.feuapp.daihuudsf.models.ImgStore;
import net.feuapp.daihuudsf.models.KhachHang;
import net.feuapp.daihuudsf.models.ResponseFromServer;

import net.feuapp.daihuudsf.models.TVCanCa;
import net.feuapp.daihuudsf.models.Thu;
import net.feuapp.daihuudsf.models.ThuDetail;
import net.feuapp.daihuudsf.models.Ticket;
import net.feuapp.daihuudsf.models.TicketDetail;
import net.feuapp.daihuudsf.models.Users;
...
import static net.feuapp.daihuudsf.utils.utils.readFromFile;
import static net.feuapp.daihuudsf.utils.utils.writeToFile;
...
public class SyncAdapter extends AbstractThreadedSyncAdapter {
    // Global variables
    private static final String TAG = "DaiHuuDSF-syncAdapter";
    ...
    private String BASE_URL_USERS, BASE_URL_DSTV, BASE_URL_CHUYENBIEN, BASE_URL_DIEMDD,
            ...
            BASE_URL_DMHAISAN, BASE_URL_TVCANCA, BASE_URL_BANHSDETAIL, BASE_URL_IMGSTORE;
    ...
    public void onPerformSync(Account account, Bundle extras, String authority, ContentProviderClient provider, SyncResult syncResult) {
        ...
        File filePre = new File("/data/data/"+ getContext().getPackageName()+ "/shared_prefs/daihuudsf_preferences.xml");
        if (filePre.exists()) {
            getPre();
        }else{
            return;
        ...
        BASE_URL_USERS= MY_SERVER + "/daihuudsf/user";
        BASE_URL_CHUYENBIEN= MY_SERVER + "/daihuudsf/chuyenbien";
        BASE_URL_DSTV= MY_SERVER + "/daihuudsf/dstv";
        BASE_URL_DOITAC= MY_SERVER + "/daihuudsf/doitac";
        BASE_URL_KHACHHANG= MY_SERVER + "/daihuudsf/khachhang";
        BASE_URL_DEBTBOOK= MY_SERVER + "/daihuudsf/debtbook";
        BASE_URL_DIEMDD= MY_SERVER + "/daihuudsf/diemdd";
        BASE_URL_TICKET= MY_SERVER + "/daihuudsf/ticket";
        BASE_URL_TICKETDETAIL= MY_SERVER + "/daihuudsf/ticketdetail";
        BASE_URL_THU= MY_SERVER + "/daihuudsf/thu";
        BASE_URL_THUDETAIL= MY_SERVER + "/daihuudsf/thudetail";
        BASE_URL_CHI= MY_SERVER + "/daihuudsf/chi";
        BASE_URL_CHIDETAIL= MY_SERVER + "/daihuudsf/chidetail";
        BASE_URL_DMHAISAN= MY_SERVER + "/daihuudsf/dmhaisan";
        BASE_URL_TVCANCA= MY_SERVER + "/daihuudsf/tvcanca";
        BASE_URL_IMGSTORE= MY_SERVER + "/daihuudsf/imgstore";
        BASE_URL_BANHSDETAIL= MY_SERVER + "/daihuudsf/banhsdetail";
    ...
    private int ReadSyncType(){
        ...
        baseDir+="/Android/data/net.feuapp.daihuudsf";
        File file = new File(baseDir + "/" + fileSyncType);
        if (file.exists()){
            StrSyncType=readFromFile(file);
    ...
    private void getPre(){
        SharedPreferences sharedpre = getContext().getSharedPreferences("daihuudsf_preferences", getContext().MODE_PRIVATE);
    ...
    private void doLocalRkeyChange() {
        ...
        ArrayList<TVCanCa> arrTVCanCa =  new ArrayList<>();
        ...
        arrTVCanCa=TVCanCa_getAllTVCanCa();
        for (int a = 0; a < arrDSTV.size(); a++) {
            ...
            if (dstv.getServerkey() != 0 && dstv.getRkey() != dstv.getServerkey()) {
                ...
                for (int d = 0; d < arrTVCanCa.size(); d++) {
                    TVCanCa tvcanca = new TVCanCa();
                    tvcanca = arrTVCanCa.get(d);
                    if (tvcanca.getRkeythuyenvien() == dstv.getRkey()) {
                        tvcanca.setRkeythuyenvien(dstv.getServerkey());
                        tvcanca.setUpdatetime(String.valueOf(longGet(tvcanca.getUpdatetime()) + 1));
                        //crudLocaldb.TVCanCa_updateTVCanCa(tvcanca);
                        TVCanCa_updateTVCanCa(tvcanca);
                    }
                }
        ...
        //thang tvcanca khong co con
        arrTVCanCa=TVCanCa_getChuaEditRkey();
        for (int i = 0; i < arrTVCanCa.size(); i++) {
            TVCanCa tvcanca = new TVCanCa();
            tvcanca = arrTVCanCa.get(i);
            if (tvcanca.getServerkey() != tvcanca.getRkey() && tvcanca.getServerkey() != 0) {
                tvcanca.setRkey(tvcanca.getServerkey());
                tvcanca.setUpdatetime(String.valueOf(longGet(tvcanca.getUpdatetime()) + 1));
                //int u=crudLocaldb.TVCanCa_updateTVCanCa(tvcanca);
                int u = TVCanCa_updateTVCanCa(tvcanca);
            }
    ...
    private void SyncDelete(){
        ...
        if (arrWDFS.size()>0){
            for (int i = 0; i < arrWDFS.size(); i++) {
                ...
                if (wdfs.getmTablename().equals("tvcanca")){
                    try{
                        String DeleteURL=BASE_URL_TVCANCA+ "/delete/" + wdfs.getmServerkey() + "/";
                        restfullAPI.deleteTVCanCa  task = new restfullAPI.deleteTVCanCa();
                        task.setUpdateListener(new restfullAPI.deleteTVCanCa.OnUpdateListener(){
                            @Override
                            public void onUpdate(ResponseFromServer res) {
                                if (res==null){return;}
                                if (res.getStatus()==0){
                                    ...
                                    int d=WDFS_deleteWDFS(wdfs.getmId());
                                    if (d!=0){
                                        Log.d(TAG, "Synchronize TVCanCa, delete like client: ---------------- " + d +"");
                                    }
                                }
                            }
                        });
        ...
        ArrayList<TVCanCa>arrTVCanCa=TVCanCa_getAllTVCanCa();
        ...
        for (int i = 0; i < arrTVCanCa.size(); i++) {
        final TVCanCa tvcanca=arrTVCanCa.get(i);
        if (tvcanca.getServerkey()!=0){
            final String myurl=BASE_URL_TVCANCA+"/count/"+ tvcanca.getServerkey() +"/";
            restfullAPI.countOnServer  countTask = new restfullAPI.countOnServer();
            countTask.setUpdateListener(new restfullAPI.countOnServer.OnUpdateListener(){
                @Override
                public void onUpdate( ResponseFromServer res) {
                    ...
                    if (res.getStatus()==0){
                        //xoa trong danh sach
                        int d=TVCanCa_deleteTVCanCa(tvcanca.getId());
                        if (d!=0){
                            Log.d(TAG, "Synchronize TVCanCa, delete like server: ---------------- " + d +"");
                        }
                    }
                }
            });
    ...
    private void SyncPullFromServer(){
        ...
        restfullAPI.getTVCanCa  pullTVCanCa = new restfullAPI.getTVCanCa();
        pullTVCanCa.setUpdateListener(new restfullAPI.getTVCanCa.OnUpdateListener(){
            ArrayList<TVCanCa> arrServerTVCanCa=new ArrayList<>();
            @Override
            public void onUpdate(ArrayList<TVCanCa> obj) {
                if (obj==null){return;}
                arrServerTVCanCa=obj;
                ArrayList<TVCanCa>arrLocalTVCanCa=new ArrayList<>();
                arrLocalTVCanCa=TVCanCa_getAllTVCanCa();
                if (arrServerTVCanCa.size()>arrLocalTVCanCa.size()){
                    for (int i=0; i<arrServerTVCanCa.size();i++){
                        final TVCanCa serverTVCanCa=arrServerTVCanCa.get(i);
                        if (serverTVCanCa.getServerkey()!=0){
                            if (!TVCanCa_Exits(serverTVCanCa.getServerkey())){
                                if (!WDFS_Exits(arrWDFS,"tvcanca",serverTVCanCa.getServerkey())){
                                    Uri uri = TVCanCa_addTVCanCa(serverTVCanCa);
                                    if (uri!=null){
                                        Log.d(TAG, "Pull TVCanCa From Server: ----------------------" + serverTVCanCa.getServerkey());
                                    }
                                }
                            }
                        }
        ...
        pullTVCanCa.execute(BASE_URL_TVCANCA);
    ...
    private void SyncEditTwoWay(){
        ...
        final ArrayList<TVCanCa>arrTVCanCa=TVCanCa_getAllTVCanCa();
        ...
        restfullAPI.getTVCanCa syncTVCanCa = new restfullAPI.getTVCanCa();
        syncTVCanCa.setUpdateListener(new restfullAPI.getTVCanCa.OnUpdateListener(){
            @Override
            public void onUpdate(ArrayList<TVCanCa> arrServerTVCanCa) throws ExecutionException, InterruptedException {
                if (arrServerTVCanCa==null || arrTVCanCa.size()==0){return;}
                if (arrServerTVCanCa.size()>0){
                    for (int i = 0; i < arrServerTVCanCa.size(); i++) {
                        final TVCanCa servertvcanca=arrServerTVCanCa.get(i);
                        if (arrTVCanCa.size()>0){
                            for (int j=0; j<arrTVCanCa.size();j++){
                                final TVCanCa tvcanca=arrTVCanCa.get(j);
                                if (tvcanca.getServerkey()==servertvcanca.getServerkey()){
                                    if (timeGet(tvcanca.getUpdatetime())==timeGet(servertvcanca.getUpdatetime())){
                                        break;
                                    }
                                    if (timeGet(tvcanca.getUpdatetime())>timeGet(servertvcanca.getUpdatetime())){
                                        //sua theo clent
                                        final String myurl=BASE_URL_TVCANCA + "/update/"+ tvcanca.getServerkey() +"/";
                                        final String oldUpTime=servertvcanca.getUpdatetime();
                                        final String newUpTime=tvcanca.getUpdatetime();
                                        restfullAPI.putTVCanCa taskPut = new restfullAPI.putTVCanCa(tvcanca);
                                        taskPut.setUpdateListener(new restfullAPI.putTVCanCa.OnUpdateListener(){;
                                            @Override
                                            public void onUpdate(ResponseFromServer res) {
                                                if (res==null){return;}
                                                if (res.getStatus()==0){
                                                    Log.d(TAG, "two ways sync TVCanCa, do like local: ------------local: " + newUpTime + "-----------server: " + oldUpTime);
                                                }
                                            }
                                        });
                                        taskPut.execute(myurl);
                                        ...
                                        //sua theo server
                                        final String oldUpTime=tvcanca.getUpdatetime();
                                        TVCanCa tvcanca2local=servertvcanca;
                                        //sua lai id cho hop ly, k the lay id cua thang server dc
                                        tvcanca2local.setId(tvcanca.getId());
                                        int u=TVCanCa_updateTVCanCa(tvcanca2local);
                                        if (u!=0){
                                            Log.d(TAG, "two ways sync TVCanCa, do like server: -----------local: "+oldUpTime+"-----------server: " + servertvcanca.getUpdatetime());
                                        }
                                    }
                                }
                            }
        ...
        syncTVCanCa.execute(BASE_URL_TVCANCA);
    ...
    private void SyncPostToServer(){
        ...
        final String URLcreateTVCanCa=BASE_URL_TVCANCA + "/create/";
        ...
        ArrayList<TVCanCa>arrTVCanCa=TVCanCa_getAllTVCanCa();
        for (int i = 0; i < arrTVCanCa.size(); i++) {
            final TVCanCa finalLocalTVCanCa=arrTVCanCa.get(i);
            if (finalLocalTVCanCa.getServerkey()==0){
                restfullAPI.postTVCanCa task2 = new restfullAPI.postTVCanCa(finalLocalTVCanCa);
                task2.setUpdateListener(new restfullAPI.postTVCanCa.OnUpdateListener(){;
                    @Override
                    public void onUpdate(ResponseFromServer res) {
                        if (res==null){return;}
                        if (res.getStatus()==0){
                            finalLocalTVCanCa.setServerkey(res.getServerkey());
                            //cap nhat serverkey cho client
                            int u=TVCanCa_updateTVCanCa(finalLocalTVCanCa);
                            if (u!=0) {
                                Log.d(TAG, "TVCanCa postToServer - Updated ServerKey On Client: ----------------------" + String.valueOf(u) + "==========" + finalLocalTVCanCa.getServerkey());
                            }
                        }
                    }
                });
                task2.execute(URLcreateTVCanCa);
            }
        }
        ArrayList<BanHSDetail>arrBanHSDetail=BanHSDetail_getAllBanHSDetail();
        for (int i = 0; i < arrBanHSDetail.size(); i++) {
    ...
    //********************************POST ALL FROM LOCAL TO SERVER**************************
    private void PostAllToServerByRecovery(){
        Log.d(TAG, "PostAllToServerByRecovery: ------------------------PostAllToServerByRecovery------------------------------");
        final String URLcreateUsers=BASE_URL_USERS + "/create/";
        final String URLcreateDSTV=BASE_URL_DSTV + "/create/";
        final String URLcreateChuyenBien=BASE_URL_CHUYENBIEN + "/create/";
        final String URLcreateDiemDD=BASE_URL_DIEMDD + "/create/";
        ...
        syncImgStore.setUpdateListener(new restfullAPI.getImgStore.OnUpdateListener(){
            ...
            public void onUpdate(ArrayList<ImgStore> arrServerImgStore) throws ExecutionException, InterruptedException {
                if (arrServerImgStore==null || arrImgStore.size()==0){return;}
                if (arrServerImgStore.size()<arrImgStore.size()){
                    for (int i = 0; i < arrImgStore.size(); i++) {
                        ImgStore imgstorefirst=arrImgStore.get(i);
                        //post du lieu text
                        restfullAPI.postImgStore task2 = new restfullAPI.postImgStore(imgstorefirst);
                        final int finalI = i;
                        task2.setUpdateListener(new restfullAPI.postImgStore.OnUpdateListener(){;
                                        ...
                                        taskpostfile.setUpdateListener(new restfullAPI.postFile.OnUpdateListener() {
                                            ...
                                            public void onUpdate(ResponseFromServer obj) {
                                                ...
                                                if (obj.getStatus()==0){
                                                    ...
                                                    if (timeGet(imgstorefirst.getUpdatetime())<NGAY_LUU_ANH){
                                                        //delete file first
                                                        utils.deleteFile(imgstorefirst.getImgpath());
                                                        imgstorefirst.setServerkey(svkey);
                                                        imgstorefirst.setImgpath(ImageHoaDonURL);
                                                        //cap nhat imghoadon cho client theo link server
                                                        int u=ImgStore_updateImgStore(imgstorefirst);
        ...
        syncDSTV.setUpdateListener(new restfullAPI.getDSTV.OnUpdateListener(){
            ...
            public void onUpdate(ArrayList<DSTV> arrServerDSTV) throws ExecutionException, InterruptedException {
                if (arrServerDSTV==null || arrDSTV.size()==0){return;}
                if (arrServerDSTV.size()<arrDSTV.size()){
                    for (int i = 0; i < arrDSTV.size(); i++) {
                        DSTV finalLocalDSTV=arrDSTV.get(i);
                        restfullAPI.postDSTV task2 = new restfullAPI.postDSTV(finalLocalDSTV);
                        task2.setUpdateListener(new restfullAPI.postDSTV.OnUpdateListener(){;
                            @Override
                            public void onUpdate(ResponseFromServer res) {
        ...
        syncChuyenBien.setUpdateListener(new restfullAPI.getChuyenBien.OnUpdateListener(){
            ...
            public void onUpdate(ArrayList<ChuyenBien> arrServerChuyenBien) throws ExecutionException, InterruptedException {
                if (arrServerChuyenBien==null || arrChuyenBien.size()==0){return;}
                if (arrServerChuyenBien.size()<arrChuyenBien.size()){
                    for (int i = 0; i < arrChuyenBien.size(); i++) {
                        ChuyenBien finalLocalChuyenBien=arrChuyenBien.get(i);
                        restfullAPI.postChuyenBien task2 = new restfullAPI.postChuyenBien(finalLocalChuyenBien);
                        task2.setUpdateListener(new restfullAPI.postChuyenBien.OnUpdateListener(){;
                            @Override
                            public void onUpdate(ResponseFromServer res) {
        ...
        syncDiemDD.setUpdateListener(new restfullAPI.getDiemDD.OnUpdateListener(){
            ...
            public void onUpdate(ArrayList<DiemDD> arrServerDiemDD) throws ExecutionException, InterruptedException {
                if (arrServerDiemDD==null || arrDiemDD.size()==0){return;}
                if (arrServerDiemDD.size()<arrDiemDD.size()){
                    for (int i = 0; i < arrDiemDD.size(); i++) {
                        DiemDD finalLocalDiemDD=arrDiemDD.get(i);
                        restfullAPI.postDiemDD task2 = new restfullAPI.postDiemDD(finalLocalDiemDD);
                        task2.setUpdateListener(new restfullAPI.postDiemDD.OnUpdateListener(){;
                            @Override
                            public void onUpdate(ResponseFromServer res) {
        ...
        syncKhachHang.setUpdateListener(new restfullAPI.getKhachHang.OnUpdateListener(){
            ...
            public void onUpdate(ArrayList<KhachHang> arrServerKhachHang) throws ExecutionException, InterruptedException {
                if (arrServerKhachHang==null || arrKhachHang.size()==0){return;}
                if (arrServerKhachHang.size()<arrKhachHang.size()){
                    for (int i = 0; i < arrKhachHang.size(); i++) {
                        KhachHang finalLocalKhachHang=arrKhachHang.get(i);
                        restfullAPI.postKhachHang task2 = new restfullAPI.postKhachHang(finalLocalKhachHang);
                        task2.setUpdateListener(new restfullAPI.postKhachHang.OnUpdateListener(){;
                            @Override
                            public void onUpdate(ResponseFromServer res) {
        ...
        syncDoiTac.setUpdateListener(new restfullAPI.getDoiTac.OnUpdateListener(){
            ...
            public void onUpdate(ArrayList<DoiTac> arrServerDoiTac) throws ExecutionException, InterruptedException {
                if (arrServerDoiTac==null || arrDoiTac.size()==0){return;}
                if (arrServerDoiTac.size()<arrDoiTac.size()){
                    for (int i = 0; i < arrDoiTac.size(); i++) {
                        DoiTac finalLocalDoiTac=arrDoiTac.get(i);
                        restfullAPI.postDoiTac task2 = new restfullAPI.postDoiTac(finalLocalDoiTac);
                        task2.setUpdateListener(new restfullAPI.postDoiTac.OnUpdateListener(){;
                            @Override
                            public void onUpdate(ResponseFromServer res) {
        ...
        syncTicket.setUpdateListener(new restfullAPI.getTicket.OnUpdateListener(){
            ...
            public void onUpdate(ArrayList<Ticket> arrServerTicket) throws ExecutionException, InterruptedException {
                if (arrServerTicket==null || arrTicket.size()==0){return;}
                if (arrServerTicket.size()<arrTicket.size()){
                    for (int i = 0; i < arrTicket.size(); i++) {
                        Ticket finalLocalTicket=arrTicket.get(i);
                        restfullAPI.postTicket task2 = new restfullAPI.postTicket(finalLocalTicket);
                        task2.setUpdateListener(new restfullAPI.postTicket.OnUpdateListener(){;
                            @Override
                            public void onUpdate(ResponseFromServer res) {
        ...
        syncTicketDetail.setUpdateListener(new restfullAPI.getTicketDetail.OnUpdateListener(){
            ...
            public void onUpdate(ArrayList<TicketDetail> arrServerTicketDetail) throws ExecutionException, InterruptedException {
                if (arrServerTicketDetail==null || arrTicketDetail.size()==0){return;}
                if (arrServerTicketDetail.size()<arrTicketDetail.size()){
                    for (int i = 0; i < arrTicketDetail.size(); i++) {
                        TicketDetail finalLocalTicketDetail=arrTicketDetail.get(i);
                        restfullAPI.postTicketDetail task2 = new restfullAPI.postTicketDetail(finalLocalTicketDetail);
                        task2.setUpdateListener(new restfullAPI.postTicketDetail.OnUpdateListener(){;
                            @Override
                            public void onUpdate(ResponseFromServer res) {
        ...
        syncThu.setUpdateListener(new restfullAPI.getThu.OnUpdateListener(){
            ...
            public void onUpdate(ArrayList<Thu> arrServerThu) throws ExecutionException, InterruptedException {
                if (arrServerThu==null || arrThu.size()==0){return;}
                if (arrServerThu.size()<arrThu.size()){
                    for (int i = 0; i < arrThu.size(); i++) {
                        Thu finalLocalThu=arrThu.get(i);
                        restfullAPI.postThu task2 = new restfullAPI.postThu(finalLocalThu);
                        task2.setUpdateListener(new restfullAPI.postThu.OnUpdateListener(){;
                            @Override
                            public void onUpdate(ResponseFromServer res) {
        ...
        syncThuDetail.setUpdateListener(new restfullAPI.getThuDetail.OnUpdateListener(){
            ...
            public void onUpdate(ArrayList<ThuDetail> arrServerThuDetail) throws ExecutionException, InterruptedException {
                if (arrServerThuDetail==null || arrThuDetail.size()==0){return;}
                if (arrServerThuDetail.size()<arrThuDetail.size()){
                    for (int i = 0; i < arrThuDetail.size(); i++) {
                        ThuDetail finalLocalThuDetail=arrThuDetail.get(i);
                        restfullAPI.postThuDetail task2 = new restfullAPI.postThuDetail(finalLocalThuDetail);
                        task2.setUpdateListener(new restfullAPI.postThuDetail.OnUpdateListener(){;
                            @Override
                            public void onUpdate(ResponseFromServer res) {
        ...
        syncChi.setUpdateListener(new restfullAPI.getChi.OnUpdateListener(){
            ...
            public void onUpdate(ArrayList<Chi> arrServerChi) throws ExecutionException, InterruptedException {
                if (arrServerChi==null || arrChi.size()==0){return;}
                if (arrServerChi.size()<arrChi.size()){
                    for (int i = 0; i < arrChi.size(); i++) {
                        Chi finalLocalChi=arrChi.get(i);
                        restfullAPI.postChi task2 = new restfullAPI.postChi(finalLocalChi);
                        task2.setUpdateListener(new restfullAPI.postChi.OnUpdateListener(){;
                            @Override
                            public void onUpdate(ResponseFromServer res) {
        ...
        syncChiDetail.setUpdateListener(new restfullAPI.getChiDetail.OnUpdateListener(){
            ...
            public void onUpdate(ArrayList<ChiDetail> arrServerChiDetail) throws ExecutionException, InterruptedException {
                if (arrServerChiDetail==null || arrChiDetail.size()==0){return;}
                if (arrServerChiDetail.size()<arrChiDetail.size()){
                    for (int i = 0; i < arrChiDetail.size(); i++) {
                        ChiDetail finalLocalChiDetail=arrChiDetail.get(i);
                        restfullAPI.postChiDetail task2 = new restfullAPI.postChiDetail(finalLocalChiDetail);
                        task2.setUpdateListener(new restfullAPI.postChiDetail.OnUpdateListener(){;
                            @Override
                            public void onUpdate(ResponseFromServer res) {
        ...
        syncDebtBook.setUpdateListener(new restfullAPI.getDebtBook.OnUpdateListener(){
            ...
            public void onUpdate(ArrayList<DebtBook> arrServerDebtBook) throws ExecutionException, InterruptedException {
                if (arrServerDebtBook==null || arrDebtBook.size()==0){return;}
                if (arrServerDebtBook.size()<arrDebtBook.size()){
                    for (int i = 0; i < arrDebtBook.size(); i++) {
                        DebtBook finalLocalDebtBook=arrDebtBook.get(i);
                        restfullAPI.postDebtBook task2 = new restfullAPI.postDebtBook(finalLocalDebtBook);
                        task2.setUpdateListener(new restfullAPI.postDebtBook.OnUpdateListener(){;
                            @Override
                            public void onUpdate(ResponseFromServer res) {
        ...
        syncDMHaiSan.setUpdateListener(new restfullAPI.getDMHaiSan.OnUpdateListener(){
            ...
            public void onUpdate(ArrayList<DMHaiSan> arrServerDMHaiSan) throws ExecutionException, InterruptedException {
                if (arrServerDMHaiSan==null || arrDMHaiSan.size()==0){return;}
                if (arrServerDMHaiSan.size()<arrDMHaiSan.size()){
                    for (int i = 0; i < arrDMHaiSan.size(); i++) {
                        DMHaiSan finalLocalDMHaiSan=arrDMHaiSan.get(i);
                        restfullAPI.postDMHaiSan task2 = new restfullAPI.postDMHaiSan(finalLocalDMHaiSan);
                        task2.setUpdateListener(new restfullAPI.postDMHaiSan.OnUpdateListener(){;
                            @Override
                            public void onUpdate(ResponseFromServer res) {
        ...
        syncTVCanCa.setUpdateListener(new restfullAPI.getTVCanCa.OnUpdateListener(){
            ...
            public void onUpdate(ArrayList<TVCanCa> arrServerTVCanCa) throws ExecutionException, InterruptedException {
                if (arrServerTVCanCa==null || arrTVCanCa.size()==0){return;}
                if (arrServerTVCanCa.size()<arrTVCanCa.size()){
                    for (int i = 0; i < arrTVCanCa.size(); i++) {
                        TVCanCa finalLocalTVCanCa=arrTVCanCa.get(i);
                        restfullAPI.postTVCanCa task2 = new restfullAPI.postTVCanCa(finalLocalTVCanCa);
                        task2.setUpdateListener(new restfullAPI.postTVCanCa.OnUpdateListener(){;
                            @Override
                            public void onUpdate(ResponseFromServer res) {
        ...
        syncBanHSDetail.setUpdateListener(new restfullAPI.getBanHSDetail.OnUpdateListener(){
            ...
            public void onUpdate(ArrayList<BanHSDetail> arrServerBanHSDetail) throws ExecutionException, InterruptedException {
                if (arrServerBanHSDetail==null || arrBanHSDetail.size()==0){return;}
                if (arrServerBanHSDetail.size()<arrBanHSDetail.size()){
                    for (int i = 0; i < arrBanHSDetail.size(); i++) {
                        BanHSDetail finalLocalBanHSDetail=arrBanHSDetail.get(i);
                        restfullAPI.postBanHSDetail task2 = new restfullAPI.postBanHSDetail(finalLocalBanHSDetail);
                        task2.setUpdateListener(new restfullAPI.postBanHSDetail.OnUpdateListener(){;
                            @Override
                            public void onUpdate(ResponseFromServer res) {
    ...
    private ArrayList<Users>Users_getChuaEditRkey(){
        ArrayList<Users>arrLocalUsers=new ArrayList<>();
        Uri URI_ChuaEditRkey = Uri.parse("content://net.feuapp.daihuudsf.syncAdapter.StubProvider/users/chuaEditRkey");
    ...
    private boolean Users_Exits(int serverKey){
        boolean r=false;
        Uri SYNCTABLE_URI_ID = Uri.parse("content://net.feuapp.daihuudsf.syncAdapter.StubProvider/users/"+serverKey);
        Cursor cursor = null;
    ...
    private ArrayList<DSTV>DSTV_getChuaEditRkey(){
        ArrayList<DSTV>arrLocalDSTV=new ArrayList<>();
        Uri URI_ChuaEditRkey = Uri.parse("content://net.feuapp.daihuudsf.syncAdapter.StubProvider/dstv/chuaEditRkey");
        Cursor cursor = mContentResolver.query(URI_ChuaEditRkey, null, null, null, null);
        if (cursor != null) {
            if (cursor.moveToFirst()) {
                do {
    ...
    private boolean DSTV_Exits(int serverKey) {
        boolean r=false;
        Uri SYNCTABLE_URI_ID = Uri.parse("content://net.feuapp.daihuudsf.syncAdapter.StubProvider/dstv/"+serverKey);
        Cursor cursor = null;
        cursor = mContentResolver.query(SYNCTABLE_URI_ID, null, null, null, null);
        if (cursor.moveToFirst()){
            r=true;
    ...
    private ArrayList<ChuyenBien>ChuyenBien_getChuaEditRkey(){
        ArrayList<ChuyenBien>arrLocalChuyenBien=new ArrayList<>();
        Uri URI_ChuaEditRkey = Uri.parse("content://net.feuapp.daihuudsf.syncAdapter.StubProvider/chuyenbien/chuaEditRkey");
        Cursor cursor = mContentResolver.query(URI_ChuaEditRkey, null, null, null, null);
        if (cursor != null) {
            if (cursor.moveToFirst()) {
                do {
    ...
    private boolean ChuyenBien_Exits(int serverKey){
        boolean r=false;
        Uri SYNCTABLE_URI_ID = Uri.parse("content://net.feuapp.daihuudsf.syncAdapter.StubProvider/chuyenbien/"+serverKey);
        Cursor cursor = null;
        cursor = mContentResolver.query(SYNCTABLE_URI_ID, null, null, null, null);
        if (cursor.moveToFirst()){
            r=true;
    ...
    private ArrayList<Ticket>Ticket_getChuaEditRkey() {
        ArrayList<Ticket> arrLocalTicket = new ArrayList<>();
        Uri URI_ChuaEditRkey = Uri.parse("content://net.feuapp.daihuudsf.syncAdapter.StubProvider/ticket/chuaEditRkey");
        Cursor cursor = mContentResolver.query(URI_ChuaEditRkey, null, null, null, null);
        if (cursor != null) {
            if (cursor.moveToFirst()) {
                do {
    ...
    private boolean Ticket_Exits(int serverKey){
        boolean r=false;
        Uri SYNCTABLE_URI_ID = Uri.parse("content://net.feuapp.daihuudsf.syncAdapter.StubProvider/ticket/"+serverKey);
        Cursor cursor = null;
        cursor = mContentResolver.query(SYNCTABLE_URI_ID, null, null, null, null);
        if (cursor.moveToFirst()){
            r=true;
    ...
    private ArrayList<TicketDetail>TicketDetail_getChuaEditRkey(){
        ArrayList<TicketDetail>arrLocalTicketDetail=new ArrayList<>();
        Uri URI_ChuaEditRkey = Uri.parse("content://net.feuapp.daihuudsf.syncAdapter.StubProvider/ticketdetail/chuaEditRkey");
        Cursor cursor = mContentResolver.query(URI_ChuaEditRkey, null, null, null, null);
        if (cursor != null) {
            if (cursor.moveToFirst()) {
                do {
    ...
    private boolean TicketDetail_Exits(int serverKey){
        boolean r=false;
        Uri SYNCTABLE_URI_ID = Uri.parse("content://net.feuapp.daihuudsf.syncAdapter.StubProvider/ticketdetail/"+serverKey);
        Cursor cursor = null;
        cursor = mContentResolver.query(SYNCTABLE_URI_ID, null, null, null, null);
        if (cursor.moveToFirst()){
            r=true;
    ...
    private ArrayList<DoiTac>DoiTac_getChuaEditRkey(){
        ArrayList<DoiTac>arrLocalDoiTac=new ArrayList<>();
        Uri URI_ChuaEditRkey = Uri.parse("content://net.feuapp.daihuudsf.syncAdapter.StubProvider/doitac/chuaEditRkey");
        Cursor cursor = mContentResolver.query(URI_ChuaEditRkey, null, null, null, null);
        if (cursor != null) {
            if (cursor.moveToFirst()) {
                do {
    ...
    private boolean DoiTac_Exits(int serverKey){
        boolean r=false;
        Uri SYNCTABLE_URI_ID = Uri.parse("content://net.feuapp.daihuudsf.syncAdapter.StubProvider/doitac/"+serverKey);
        Cursor cursor = null;
        cursor = mContentResolver.query(SYNCTABLE_URI_ID, null, null, null, null);
        if (cursor.moveToFirst()){
            r=true;
    ...
    private ArrayList<KhachHang>KhachHang_getChuaEditRkey(){
        ArrayList<KhachHang>arrLocalKhachHang=new ArrayList<>();
        Uri URI_ChuaEditRkey = Uri.parse("content://net.feuapp.daihuudsf.syncAdapter.StubProvider/khachhang/chuaEditRkey");
        Cursor cursor = mContentResolver.query(URI_ChuaEditRkey, null, null, null, null);
        if (cursor != null) {
            if (cursor.moveToFirst()) {
                do {
    ...
    private boolean KhachHang_Exits(int serverKey){
        boolean r=false;
        Uri SYNCTABLE_URI_ID = Uri.parse("content://net.feuapp.daihuudsf.syncAdapter.StubProvider/khachhang/"+serverKey);
        Cursor cursor = null;
        cursor = mContentResolver.query(SYNCTABLE_URI_ID, null, null, null, null);
        if (cursor.moveToFirst()){
            r=true;
    ...
    private ArrayList<DebtBook>DebtBook_getChuaEditRkey(){
        ArrayList<DebtBook>arrLocalDebtBook=new ArrayList<>();
        Uri URI_ChuaEditRkey = Uri.parse("content://net.feuapp.daihuudsf.syncAdapter.StubProvider/debtbook/chuaEditRkey");
        Cursor cursor = mContentResolver.query(URI_ChuaEditRkey, null, null, null, null);
        if (cursor != null) {
            if (cursor.moveToFirst()) {
                do {
    ...
    private boolean DebtBook_Exits(int serverKey){
        boolean r=false;
        Uri SYNCTABLE_URI_ID = Uri.parse("content://net.feuapp.daihuudsf.syncAdapter.StubProvider/debtbook/"+serverKey);
        Cursor cursor = null;
        cursor = mContentResolver.query(SYNCTABLE_URI_ID, null, null, null, null);
        if (cursor.moveToFirst()){
            r=true;
    ...
    private ArrayList<Thu>Thu_getChuaEditRkey(){
        ArrayList<Thu>arrLocalThu=new ArrayList<>();
        Uri URI_ChuaEditRkey = Uri.parse("content://net.feuapp.daihuudsf.syncAdapter.StubProvider/thu/chuaEditRkey");
        Cursor cursor = mContentResolver.query(URI_ChuaEditRkey, null, null, null, null);
        if (cursor != null) {
            if (cursor.moveToFirst()) {
                do {
    ...
    private boolean Thu_Exits(int serverKey){
        boolean r=false;
        Uri SYNCTABLE_URI_ID = Uri.parse("content://net.feuapp.daihuudsf.syncAdapter.StubProvider/thu/"+serverKey);
        Cursor cursor = null;
        cursor = mContentResolver.query(SYNCTABLE_URI_ID, null, null, null, null);
        if (cursor.moveToFirst()){
            r=true;
    ...
    private ArrayList<ThuDetail>ThuDetail_getChuaEditRkey(){
        ArrayList<ThuDetail>arrLocalThuDetail=new ArrayList<>();
        Uri URI_ChuaEditRkey = Uri.parse("content://net.feuapp.daihuudsf.syncAdapter.StubProvider/thudetail/chuaEditRkey");
        Cursor cursor = mContentResolver.query(URI_ChuaEditRkey, null, null, null, null);
        if (cursor != null) {
            if (cursor.moveToFirst()) {
                do {
    ...
    private boolean ThuDetail_Exits(int serverKey){
        boolean r=false;
        Uri SYNCTABLE_URI_ID = Uri.parse("content://net.feuapp.daihuudsf.syncAdapter.StubProvider/thudetail/"+serverKey);
        Cursor cursor = null;
        cursor = mContentResolver.query(SYNCTABLE_URI_ID, null, null, null, null);
        if (cursor.moveToFirst()){
            r=true;
    ...
    private ArrayList<Chi>Chi_getChuaEditRkey(){
        ArrayList<Chi>arrLocalChi=new ArrayList<>();
        Uri URI_ChuaEditRkey = Uri.parse("content://net.feuapp.daihuudsf.syncAdapter.StubProvider/chi/chuaEditRkey");
        Cursor cursor = mContentResolver.query(URI_ChuaEditRkey, null, null, null, null);
        if (cursor != null) {
            if (cursor.moveToFirst()) {
                do {
    ...
    private boolean Chi_Exits(int serverKey){
        boolean r=false;
        Uri SYNCTABLE_URI_ID = Uri.parse("content://net.feuapp.daihuudsf.syncAdapter.StubProvider/chi/"+serverKey);
        Cursor cursor = null;
        cursor = mContentResolver.query(SYNCTABLE_URI_ID, null, null, null, null);
        if (cursor.moveToFirst()){
            r=true;
    ...
    private ArrayList<ChiDetail>ChiDetail_getChuaEditRkey(){
        ArrayList<ChiDetail>arrLocalChiDetail=new ArrayList<>();
        Uri URI_ChuaEditRkey = Uri.parse("content://net.feuapp.daihuudsf.syncAdapter.StubProvider/chidetail/chuaEditRkey");
        Cursor cursor = mContentResolver.query(URI_ChuaEditRkey, null, null, null, null);
        if (cursor != null) {
            if (cursor.moveToFirst()) {
                do {
    ...
    private boolean ChiDetail_Exits(int serverKey){
        boolean r=false;
        Uri SYNCTABLE_URI_ID = Uri.parse("content://net.feuapp.daihuudsf.syncAdapter.StubProvider/chidetail/"+serverKey);
        Cursor cursor = null;
        cursor = mContentResolver.query(SYNCTABLE_URI_ID, null, null, null, null);
        if (cursor.moveToFirst()){
            r=true;
    ...
    private ArrayList<ImgStore>ImgStore_getChuaEditRkey(){
        ArrayList<ImgStore>arrLocalImgStore=new ArrayList<>();
        Uri URI_ChuaEditRkey = Uri.parse("content://net.feuapp.daihuudsf.syncAdapter.StubProvider/imgstore/chuaEditRkey");
        Cursor cursor = mContentResolver.query(URI_ChuaEditRkey, null, null, null, null);
        if (cursor != null) {
            if (cursor.moveToFirst()) {
                do {
    ...
    private ArrayList<ImgStore>ImgStore_getAllBadLink(){
        ArrayList<ImgStore>arrLocalImgStore=new ArrayList<>();
        Uri URI_ChuaEditRkey = Uri.parse("content://net.feuapp.daihuudsf.syncAdapter.StubProvider/imgstore/badlink");
        Cursor cursor = mContentResolver.query(URI_ChuaEditRkey, null, null, null, null);
        if (cursor != null) {
            if (cursor.moveToFirst()) {
                do {
    ...
    private ImgStore ImgStore_getImgStoreByServerKey(int ServerKey){
        ImgStore imgstore = new ImgStore();
        Uri ImgStore_URI_ID = Uri.parse("content://net.feuapp.daihuudsf.syncAdapter.StubProvider/imgstore/"+ServerKey);
        Cursor cursor = null;
    ...
    private boolean ImgStore_Exits(int serverKey){
        boolean r=false;
        Uri SYNCTABLE_URI_ID = Uri.parse("content://net.feuapp.daihuudsf.syncAdapter.StubProvider/imgstore/"+serverKey);
        Cursor cursor = null;
        cursor = mContentResolver.query(SYNCTABLE_URI_ID, null, null, null, null);
        if (cursor.moveToFirst()){
            r=true;
    ...
    private ArrayList<DiemDD>DiemDD_getChuaEditRkey(){
        ArrayList<DiemDD>arrLocalDiemDD=new ArrayList<>();
        Uri URI_ChuaEditRkey = Uri.parse("content://net.feuapp.daihuudsf.syncAdapter.StubProvider/diemdd/chuaEditRkey");
        Cursor cursor = mContentResolver.query(URI_ChuaEditRkey, null, null, null, null);
        if (cursor != null) {
            if (cursor.moveToFirst()) {
                do {
    ...
    private boolean DiemDD_Exits(int serverKey){
        boolean r=false;
        Uri SYNCTABLE_URI_ID = Uri.parse("content://net.feuapp.daihuudsf.syncAdapter.StubProvider/diemdd/"+serverKey);
        Cursor cursor = null;
        cursor = mContentResolver.query(SYNCTABLE_URI_ID, null, null, null, null);
        if (cursor.moveToFirst()){
            r=true;
    ...
    private ArrayList<DMHaiSan>DMHaiSan_getChuaEditRkey(){
        ArrayList<DMHaiSan>arrLocalDMHaiSan=new ArrayList<>();
        Uri URI_ChuaEditRkey = Uri.parse("content://net.feuapp.daihuudsf.syncAdapter.StubProvider/dmhaisan/chuaEditRkey");
        Cursor cursor = mContentResolver.query(URI_ChuaEditRkey, null, null, null, null);
        if (cursor != null) {
            if (cursor.moveToFirst()) {
                do {
    ...
    private boolean DMHaiSan_Exits(int serverKey){
        boolean r=false;
        Uri SYNCTABLE_URI_ID = Uri.parse("content://net.feuapp.daihuudsf.syncAdapter.StubProvider/dmhaisan/"+serverKey);
        Cursor cursor = null;
        cursor = mContentResolver.query(SYNCTABLE_URI_ID, null, null, null, null);
        if (cursor.moveToFirst()){
            r=true;
    ...
    //*******************************************TVCanCa*************************************
    private Uri TVCanCa_addTVCanCa(TVCanCa tvcanca){
        ContentValues values = new ContentValues();
        values.put("serverkey", tvcanca.getServerkey());
        values.put("rkey", tvcanca.getRkey());
        values.put("rkeythuyenvien", tvcanca.getRkeythuyenvien());
        values.put("ngayps", tvcanca.getNgayps());
        values.put("notes", tvcanca.getNotes());
        values.put("tenhs", tvcanca.getTenhs());
        values.put("soluong", tvcanca.getSoluong());
        values.put("dongia", tvcanca.getDongia());
        values.put("giamgia", tvcanca.getGiamgia());
        values.put("thanhtien", tvcanca.getThanhtien());
        values.put("updatetime",tvcanca.getUpdatetime());
        values.put("username", tvcanca.getUsername());
        Uri uri = null;
        uri = mContentResolver.insert(StubProvider.CONTENT_URI_TVCANCA, values);
        return uri;
    }
    private int TVCanCa_deleteTVCanCa(int ID){
        return mContentResolver.delete(StubProvider.CONTENT_URI_TVCANCA, "id=?", new String[]{ String.valueOf(ID)});
    }
    private ArrayList<TVCanCa>TVCanCa_getAllTVCanCa(){
        ArrayList<TVCanCa>arrLocalTVCanCa=new ArrayList<>();
        Cursor cursor = mContentResolver.query(StubProvider.CONTENT_URI_TVCANCA, null, null, null, null);
        if (cursor != null) {
            if (cursor.moveToFirst()) {
                do {
                    TVCanCa tvcanca = new TVCanCa();
                    tvcanca.setId(cursor.getInt(0));
                    tvcanca.setServerkey(cursor.getInt(1));
                    tvcanca.setRkey(cursor.getLong(2));
                    tvcanca.setRkeythuyenvien((cursor.getLong(3)));
                    tvcanca.setNgayps(cursor.getString(4));
                    tvcanca.setNotes(cursor.getString(5));
                    tvcanca.setTenhs(cursor.getString(6));
                    tvcanca.setSoluong(cursor.getString(7));
                    tvcanca.setDongia(cursor.getString(8));
                    tvcanca.setGiamgia(cursor.getString(9));
                    tvcanca.setThanhtien(cursor.getString(10));
                    tvcanca.setUpdatetime(cursor.getString(11));
                    tvcanca.setUsername(cursor.getString(12));
                    arrLocalTVCanCa.add(tvcanca);
                } while (cursor.moveToNext());
            }
            cursor.close();
        }
        return  arrLocalTVCanCa;
    }
    private ArrayList<TVCanCa>TVCanCa_getChuaEditRkey(){
        ArrayList<TVCanCa>arrLocalTVCanCa=new ArrayList<>();
        Uri URI_ChuaEditRkey = Uri.parse("content://net.feuapp.daihuudsf.syncAdapter.StubProvider/tvcanca/chuaEditRkey");
        Cursor cursor = mContentResolver.query(URI_ChuaEditRkey, null, null, null, null);
        if (cursor != null) {
            if (cursor.moveToFirst()) {
                do {
    ...
    private int TVCanCa_updateTVCanCa(TVCanCa tvcanca){
        ContentValues values = new ContentValues();
        values.put("serverkey", tvcanca.getServerkey());
        values.put("rkey", tvcanca.getRkey());
        values.put("rkeythuyenvien", tvcanca.getRkeythuyenvien());
        ...
        values.put("username", tvcanca.getUsername());
        int u= 0;
        u = mContentResolver.update(StubProvider.CONTENT_URI_TVCANCA, values,"id=?", new String[]{ String.valueOf(tvcanca.getId())});
        return u;
    }
    private boolean TVCanCa_Exits(int serverKey){
        boolean r=false;
        Uri SYNCTABLE_URI_ID = Uri.parse("content://net.feuapp.daihuudsf.syncAdapter.StubProvider/tvcanca/"+serverKey);
        Cursor cursor = mContentResolver.query(SYNCTABLE_URI_ID, null, null, null, null);
        if (cursor.moveToFirst()){
            r=true;
        }
        if (cursor!=null ){cursor.close();}
    ...
    private ArrayList<BanHSDetail>BanHSDetail_getChuaEditRkey() {
        ArrayList<BanHSDetail>arrLocalBanHSDetail=new ArrayList<>();
        Uri URI_ChuaEditRkey = Uri.parse("content://net.feuapp.daihuudsf.syncAdapter.StubProvider/banhsdetail/chuaEditRkey");
        Cursor cursor = mContentResolver.query(URI_ChuaEditRkey, null, null, null, null);
        if (cursor != null) {
            if (cursor.moveToFirst()) {
                do {
    ...
    private boolean BanHSDetail_Exits(int serverKey){
        boolean r=false;
        Uri SYNCTABLE_URI_ID = Uri.parse("content://net.feuapp.daihuudsf.syncAdapter.StubProvider/banhsdetail/"+serverKey);
        Cursor cursor = null;
        cursor = mContentResolver.query(SYNCTABLE_URI_ID, null, null, null, null);
        if (cursor.moveToFirst()){
            r=true;
