...
public class StubProvider extends ContentProvider {
    ...
    private final String TAG = "Dai Huu DSF";
    private final static String DATABASE_NAME = "daihuudsf.db";
    private final static int DATABASE_VERSION=1;


    public static final String PROVIDER_NAME = "net.feuapp.daihuudsf.syncAdapter.StubProvider";
    ...
    public static final Uri CONTENT_URI_TVCANCA = Uri.parse("content://" + PROVIDER_NAME + "/tvcanca");
    ...
    private static final int TVCANCA = 45;
    private static final int TVCANCA_SK = 46;
    private static final int TVCANCA_CHUAEDITRKEY = 47;
    ...
    static {
        ...
        uriMatcher.addURI(PROVIDER_NAME, "tvcanca", TVCANCA);
        uriMatcher.addURI(PROVIDER_NAME, "tvcanca/#", TVCANCA_SK);
        uriMatcher.addURI(PROVIDER_NAME, "tvcanca/chuaEditRkey", TVCANCA_CHUAEDITRKEY);
    ...
    private static class DatabaseClient extends SQLiteOpenHelper {
        ...
        private final String SQLtvcanca="CREATE TABLE IF NOT EXISTS tvcanca (id INTEGER PRIMARY KEY, " +
                "serverkey INTEGER, rkey LONG, rkeythuyenvien LONG, ngayps TEXT, notes TEXT, tenhs TEXT, soluong DOUBLE, " +
                "dongia LONG, giamgia DOUBLE, thanhtien LONG, " +
    ...
    public Uri insert(Uri uri, ContentValues values) {
        ...
        switch (uriMatcher.match(uri)) {
            ...
            case DMHAISAN:
                ...
                break;
            case TVCANCA:
                rowID = db.insert("tvcanca", "", values);
                if(rowID > 0){
                    _uri = ContentUris.withAppendedId(CONTENT_URI_TVCANCA, rowID);
                    getContext().getContentResolver().notifyChange(_uri, null);
                    return _uri;
                }
                break;
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        switch (uriMatcher.match(uri)) {
            ...
            case DMHAISAN:
                ...
                break;
            case TVCANCA:
                count = db.delete("tvcanca", selection, selectionArgs);
                break;
            case BANHSDETAIL:
    ...
    public int update(Uri uri, ContentValues values, String selection, String[] selectionArgs) {
        ...
        switch (uriMatcher.match(uri)) {
            ...
            case DMHAISAN:
                ...
                break;
            case TVCANCA:
                count = db.update("tvcanca", values, selection, selectionArgs);
                break;
            case BANHSDETAIL:
