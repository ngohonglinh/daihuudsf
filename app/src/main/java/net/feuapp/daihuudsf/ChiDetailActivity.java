...
import net.feuapp.daihuudsf.crudmanager.crudLocal;
import net.feuapp.daihuudsf.crudmanager.crudLocal;
import net.feuapp.daihuudsf.customadapters.CustomAdapterChiDetail;
...
public class ChiDetailActivity extends AppCompatActivity {
    ...
    private void UpdateSave() {
        ...
        if (intentRkeyChuyenBien == 0) {
            Toast.makeText(ChiDetailActivity.this, "Cần chính xác tên Chuyến biển", Toast.LENGTH_SHORT).show();
            return;
        }
